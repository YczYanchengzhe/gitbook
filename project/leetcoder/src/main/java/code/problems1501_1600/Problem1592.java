...
public class Problem1592 {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        String a = new Problem1592().reorderSpaces(" practice ");
        long sot = System.currentTimeMillis() - start;
        System.out.println("one sot " + sot);
    }
    ...
    public String reorderSpaces2(String text) {
        try {
            ...
            words.complete(text.trim().split("\\s+"));
            words.thenApply(wordArr -> getCount(text, wordArr))
...
//					});
    ...
    private CompletableFuture<String> getStringBuilder(int i) {
        ...
        string.complete(" ".repeat(Math.max(0, i)));
